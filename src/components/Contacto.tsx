  ...
  return (
    <section className="max-w-6xl mx-auto p-6 grid lg:grid-cols-2 gap-8 items-start">
      <div className="p-6 rounded-2xl bg-gradient-to-tr from-indigo-600 to-pink-500 text-white shadow-lg">
        ...
        <p className="mb-6 text-white/90">Cuéntame en un mensaje rápido y te responderé con una propuesta y presupuesto estimado.</p>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg">
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('Formulario simulado: enviaré la info.'); }}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-slate-500">O escribe a <strong>hola@misitio.com</strong></div>
          </div>
        </form>

        <div className="mt-6">
          <img src="https://picsum.photos/800/400?random=33" alt="Oficina" className="w-full rounded-lg object-cover h-40" />
        </div>
      </div>
    </section>
  );
